...
# Revision history: 02 Jaunary 2017 by Pilarski
# Uses: Georgia Tech Research Corporation's "lib_robotis_hack.py" 
# (Library assumes use of Python 2)
...
#D = USB2Dynamixel_Device(dev_name="/dev/tty.usbserial-AI03QDFW",baudrate=1000000)
